...
public class PartnerNewOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_partner_new_orders, container, false);
    }
    ...
    private void loadOrders(View view) {
        setLoading(view);
        RecyclerView recyclerView = view.findViewById(R.id.partner_order_new_recyclerview);
                            ...
                            view.post(()->{
                                ...
                                recyclerView.setAdapter(new PartnerOrderAdapter(
                                    ...
                                    public void addAction(@NonNull DocumentSnapshot document, Button buttonAction) {
                                        ...
                                        buttonAction.setText(R.string.mark_as_completed);
                                        buttonAction.setOnClickListener(v->{
                                            updateOrderStatus(document.getId());
                                        });
                                    }
                                });
                            });
    ...
    private void showEmptyCard(View view) {
        view.post(()->{
            ...
            ConstraintLayout emptyconstraintLayout = view.findViewById(R.id.partner_order_new_spinner_container);
            emptyconstraintLayout.setVisibility(View.VISIBLE);
            ImageView spinner = view.findViewById(R.id.partner_order_new_spinner_imageView);
