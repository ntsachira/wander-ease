...
import com.ironcodesoftware.wanderease.model.adaper.TourGuideAdapter;
...
public class PartnerGuideListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_partner_guide_list, container, false);
    }
    ...
    private void loadGuides(View view) {
        setLoading(view);

        Request request = new Request.Builder().url(BuildConfig.HOST_URL + "LoadGuides?email=" + login.getEmail()).build();
        HttpClient.getInstance().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                ...
                Log.e(MainActivity.TAG, "Guides loading failed",e);
            }
    ...
    private void loadRecycleView(View view, JsonArray jsonArray) {
        RecyclerView recyclerView = view.findViewById(R.id.partner_guide_list_recyclerView);
        recyclerView.bringToFront();
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setVisibility(View.VISIBLE);

        recyclerView.setAdapter(new TourGuideAdapter(jsonArray,getActivity()) {
            @Override
    ...
    private void showEmptyCard(View view) {
        view.post(()->{
            ...
            ConstraintLayout emptyconstraintLayout = view.findViewById(R.id.partner_guide_list_spinner_container);
            emptyconstraintLayout.setVisibility(View.VISIBLE);
            ImageView spinner = view.findViewById(R.id.partner_guide_list_spinner_imageView);
