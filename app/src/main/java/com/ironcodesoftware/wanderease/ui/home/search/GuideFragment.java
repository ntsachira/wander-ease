...
public class GuideFragment extends Fragment {
    ...
    private void loadGuides(View view) {
        ...
        Request request = new Request.Builder().url(BuildConfig.HOST_URL + "LoadGuides").build();
    ...
    private void showEmptyCard(View view) {
        view.post(()->{
            ...
            ConstraintLayout emptyconstraintLayout = view.findViewById(R.id.guide_spinner_container);
            emptyconstraintLayout.setVisibility(View.VISIBLE);
            ImageView spinner = view.findViewById(R.id.guide_spinner_imageView);
